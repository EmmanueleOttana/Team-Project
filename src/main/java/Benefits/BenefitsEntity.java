...
public class BenefitsEntity {
    ...
    public BenefitsEntity(EmployeeEntity employee, int infortuni, int giorniMalattia, int ferie, double premiProduzione, List<String> beneficiMaterialiAziendali) {
